...
public class ItemBurnerMenu extends AbstractContainerMenu {
  ...
  // For this container, we can see both the tile inventory's slots as well as the player inventory slots and the
  // hotbar.
  ...
  public ItemStack quickMoveStack(Player playerIn, int pIndex) {
    ...
    if (pIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
      if (!moveItemStackTo(
          sourceStack, TE_INVENTORY_FIRST_SLOT_INDEX, TE_INVENTORY_FIRST_SLOT_INDEX + TE_INVENTORY_SLOT_COUNT, false)) {
